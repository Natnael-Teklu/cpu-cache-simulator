...
The CPU cache lies between the main processor and the main memory, 
...
## How It Works
The program simulates the order of the programs by storing the data as unordered_map object in order to simulate
